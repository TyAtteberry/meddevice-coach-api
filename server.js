...
app.get('/debug',(req,res)=>res.json({hasAnthropicKey:!!ANTHROPIC_KEY,hasElevenLabsKey:!!ELEVENLABS_KEY,hasSupabaseKey:!!SUPABASE_KEY,hasStripeKey:!!STRIPE_SECRET_KEY,hasStripePriceId:!!STRIPE_PRICE_ID,supabaseUrl:SUPABASE_URL}));
...
async function getOnboardingCoupon() {
  try {
    ...
    // Coupon IDs must be created in your Stripe dashboard and stored as env vars
