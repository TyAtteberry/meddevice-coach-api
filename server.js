// ══════════════════════════════════════════════════════════════
// Conceromed — Backend Server v3.6
...
app.get('/',(req,res)=>res.json({status:'Conceromed API',version:'3.6'}));
...
app.post('/rep/referral/generate',authMiddleware,async(req,res)=>{
  ...
  try{
    ...
    if(rows[0]?.referral_code)return res.json({code:rows[0].referral_code});
