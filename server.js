// ══════════════════════════════════════════════════════════════
// Conceromed — Backend Server v4.21
...
app.use(cors({ origin: '*', methods: ['GET','POST','PUT','PATCH','DELETE','OPTIONS'], allowedHeaders: ['Content-Type','x-session-token','x-admin-secret','x-rep-email','x-requester-email'] }));
...
const server=app.listen(PORT,()=>console.log(`Conceromed API v4.21 running on port ${PORT}`));
