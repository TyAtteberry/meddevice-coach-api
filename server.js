// ══════════════════════════════════════════════════════════════
// Conceromed — Backend Server v4.22
...
app.get('/',(req,res)=>res.json({status:'Conceromed API',version:'4.23'}));
...
const server=app.listen(PORT,()=>console.log(`Conceromed API v4.22 running on port ${PORT}`));
