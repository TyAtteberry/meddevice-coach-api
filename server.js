// ══════════════════════════════════════════════════════════════
// Conceromed — Backend Server v3.3
...
app.post('/rep/daily-brief',authMiddleware,async(req,res)=>{
  const{repName,repEmail,products,specialties,territory,proscan,accounts,goals,quarter,
        expenseFreq,expenseLast,productiveTime,hasNextQuarter}=req.body;
...
✅ WHAT'S LOOKING GOOD
[2-3 sentences about what's going well — reference specific accounts or goal progress. Be specific and genuine.]

📋 TODAY'S FOCUS
[2-4 specific things to get done today — reference actual accounts and next steps. Numbered list, plain text.${expenseCtx?' If expense report is overdue and today looks light, include it as a numbered item.':''}]

🔮 ON THE HORIZON
[1-2 sentences about upcoming priorities.${quarterEndCtx?' ADDRESS THE QUARTER END SITUATION here — be direct and specific.':''}]

🧠 TODAY'S COACHING
[3-5 sentences of coaching personalized to their ProScan profile. Reference their specific traits by name. ${isMonday?'It is Monday — push them to set the tone for the week.':isFriday?'It is Friday — encourage reflection, celebrate wins, plan recovery.':isWeekend?'It is the weekend — encourage rest but acknowledge their drive.':'Challenge them appropriately for mid-week momentum.'} At least once per week, challenge them to schedule a STRATEGIC BLOCK — a 2-3 hour window with zero distractions (no email, no calls, no texts) dedicated purely to thinking about their business and high-value work. Suggest they schedule it during ${productiveTimeLabel} when they do their best thinking.${quarterEndCtx&&daysLeftInQuarter<=14?' Use the Strategic Block specifically for quarterly sprint planning this week.':''} The challenge is simple: try it once — reps who do it discover it becomes some of the most productive time in their week.]
...
Keep the entire brief under 350 words. Warm, human, direct. No corporate speak.`;
