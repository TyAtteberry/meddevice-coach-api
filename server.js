...
<table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
  ...
  <tr><td style="background:#ffffff;padding:40px;">
    ...
    <p style="font-size:15px;color:#333;margin:0;">— Ty Atteberry<br><span style="color:#888;font-size:13px;">Founder, Conceromed</span><br><span style="color:#aaa;font-size:12px;font-style:italic;">Former VP/SVP · Medtronic, Abbott, GT Medical Technologies</span></p>
  </td></tr>
